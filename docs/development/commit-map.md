...
| Local infrastructure  | Not behavioral | `chore(infrastructure): add local PostgreSQL and Redis services` | `docker-compose.yml`, `.env.example` | local dependencies, health checks, persistence |
